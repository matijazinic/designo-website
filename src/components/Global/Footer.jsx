...
export default function Footer() {
  return (
    <>
      <div className="bg-[#1D1C1E] -mx-[200rem] px-[200rem] lg:px-[202rem] text-white -mt-20 pt-36 md:pt-40 lg:pt-48 pb-20 flex flex-col max-sm:items-center gap-10 text-center md:text-left ">
