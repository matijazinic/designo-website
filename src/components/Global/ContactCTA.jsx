...
export default function ContactCTA() {
  return (
    <>
      <div className="bg-hero-pattern bg-cover bg-[#E7816B] bg-right rounded-lg text-white py-16 px-6 lg:px-16 xl:px-28 flex flex-col gap-10 lg:grid lg:grid-cols-2 lg:items-center">
