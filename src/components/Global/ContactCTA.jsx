...
export default function ContactCTA() {
  return (
    <>
      <div className="bg-hero-pattern bg-cover bg-brand bg-right rounded-lg text-white py-16 lg:py-20 xl:py-24 px-6 lg:px-16 xl:px-28 flex flex-col gap-10 md:gap-16 lg:grid lg:grid-cols-2 lg:items-center container mx-auto">
